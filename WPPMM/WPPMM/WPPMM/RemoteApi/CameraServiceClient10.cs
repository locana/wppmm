...
namespace WPPMM.RemoteApi
{
    ...
    /// </summary>
    public class CameraServiceClient10 : XhrPostClient
    {
        ...
        {
            Post(endpoint, RequestGenerator.setShootMode(mode),
        ...
        {
            Post(endpoint, RequestGenerator.getShootMode(),
        ...
        {
            Post(endpoint, RequestGenerator.getAvailableShootMode(),
        ...
        {
            Post(endpoint, RequestGenerator.getSupportedShootMode(),
        ...
        {
            Post(endpoint, RequestGenerator.actTakePicture(),
        ...
        {
            Post(endpoint, RequestGenerator.awaitTakePicture(),
        ...
        {
            Post(endpoint, RequestGenerator.startMovieRec(),
        ...
        {
            Post(endpoint, RequestGenerator.stopMovieRec(),
        ...
        {
            Post(endpoint, RequestGenerator.startLiveview(),
        ...
        {
            Post(endpoint, RequestGenerator.stopLiveview(),
        ...
        {
            Post(endpoint, RequestGenerator.actZoom(direction, movement),
        ...
        {
            Post(endpoint, RequestGenerator.setSelfTimer(second),
        ...
        {
            Post(endpoint, RequestGenerator.getSelfTimer(),
        ...
        {
            Post(endpoint, RequestGenerator.getSupportedSelfTimer(),
        ...
        {
            Post(endpoint, RequestGenerator.getAvailableSelfTimer(),
        ...
        {
            Post(endpoint, RequestGenerator.setPostviewImageSize(size),
        ...
        {
            Post(endpoint, RequestGenerator.getPostviewImageSize(),
        ...
        {
            Post(endpoint, RequestGenerator.getSupportedPostviewImageSize(),
        ...
        {
            Post(endpoint, RequestGenerator.getAvailablePostviewImageSize(),
        ...
        {
            Post(endpoint, RequestGenerator.startRecMode(),
        ...
        {
            Post(endpoint, RequestGenerator.stopRecMode(),
        ...
        {
            Post(endpoint, RequestGenerator.getAvailableApiList(),
        ...
        {
            Post(endpoint, RequestGenerator.getApplicationInfo(),
        ...
        {
            Post(endpoint, RequestGenerator.getVersions(),
        ...
        {
            Post(endpoint, RequestGenerator.getMethodTypes(version),
        ...
        {
            Post(endpoint, RequestGenerator.getEvent(longpolling),
